...
// MedianFiltering.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMedianFilteringApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMedianFilteringApp

CMedianFilteringApp::CMedianFilteringApp()
{
...
// Единственный объект CMedianFilteringApp

CMedianFilteringApp theApp;


// Инициализация CMedianFilteringApp

BOOL CMedianFilteringApp::InitInstance()
{
